...
const { bsv, buildContractClass, getPreimage, toHex, num2bin, Bytes, Ripemd160 } = require('scryptjs');
const {
  inputIndex,
  inputSatoshis,
  tx,
...
describe('Test sCrypt contract Counter In Javascript', () => {
  ...
  before(() => {
    const Counter = buildContractClass(loadDesc('advancedCounter_desc.json'))
    counter = new Counter()
