...
const { bsv, buildContractClass, toHex, getPreimage, num2bin, PubKey, Bytes } = require('scryptjs');
const { inputIndex, inputSatoshis, tx, loadDesc, DataLen } = require('../../helper');
...
describe('Test sCrypt contract TokenSale In Javascript', () => {
  ...
  before(() => {
    const TokenSale = buildContractClass(loadDesc('tokenSale_desc.json'))
